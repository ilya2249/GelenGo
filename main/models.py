...
class Beach(models.Model):
    ...
    def __str__(self):
        return self.name 
class TypeGeoRest(models.Model):
    name = models.CharField('Название', max_length = 255)
    code = models.CharField('Код', max_length=255)
    def __str__(self):
        return self.name  
...
class Restaurant(models.Model):
    ...
    geolocation = models.CharField('Геолокация', max_length=255,default=0)
    phone = models.CharField('Номер телефона', max_length=255,default=0)
    rating = models.CharField('Рейтинг', max_length=255,default=0)
    RatingType =  models.ForeignKey(RatingType, null=True, blank=True, on_delete=models.CASCADE)
